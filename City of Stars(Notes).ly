...
CityOfStarsFlute =  {
  ...
  a''2 r4 a''4 | % 29
  bes''4 c'''4 d'''4 f'''4  | \barNumberCheck #30
...
CityOfStarsOboe =  {
  ...
  a'4. ) g'8 a'4 c''8  a'8 ~  | % 28
  a'2 r4 a'4 | % 29
  g'4 a'4 bes'4 d''4  | \barNumberCheck #30
...
CityOfStarsSoprano =  {
  ...
  a'4. g'8 a'4 c''8  a'8 ~  | % 28
  a'2 r4 a'4 | % 29
  << { \voiceOne bes'4 c''4 d''4 f''4 } \new Voice { \voiceTwo bes'1 } >> | \barNumberCheck #30
...
CityOfStarsSopranoLyricsOne =  \lyricmode {
...
CityOfStarsAlto =  {
  ...
  cis'4 r8 cis'8 cis'8  b8 cis'8 d'8 ~  | % 46
  d'8  d'8 c'8 d'8  a8  a8 c'8 \rest a8  | % 47
  bes4 bes4 bes8  bes8 bes8 cis'8 ~ | % 48
  cis'2. r4 | % 49
  r4 a8 ^\<  e'8  \times 2/3 {
    a'4 \! g'4 f'4
  }
...
CityOfStarsAltoLyricsOne =  \lyricmode {
  That now our dreams may fi -- nally come true
  Ci -- ty of stars Just one thing eve -- ry -- bo -- dy wants
  there in the bars 
  and through the smoke -- screen of the crowd -- ed res -- tau -- rants
...
CityOfStarsTenorLyricsOne =  \lyricmode {
  Who knows? I felt it from the first em -- brace I shared with you 
   Ci -- ty of stars just one thing eve -- ry -- bo -- dy wants
   there in the bars 
  and through the smoke screen of the crowd -- ed res -- tau -- rants
  Its love Ah love from some -- one else __ A rush A touch 
  A look in some -- bo -- dy's eyes 
  to light up the skies to o -- pen the world 
  and send them feel -- ing 
...
CityOfStarsHorn =  {
  ...
  b'2. s4 | % 49
  R1*2 | % 51
  R1*9 | \barNumberCheck #60
  R1 \bar "|."
}

CityOfStarsBassLyricsOne =  \lyricmode {
  Ci  -- ty of stars, are you shi -- ning just for me?
  ...
  there in the bars 
  and through the smoke screen of the crowd -- ed res -- tau -- rants
  Its love Ah love from some -- one else __
...
CityOfStarsPianoLH =  {
  ...
  f8  a8  c'4 c'2 | % 28
  e8  a8  c'4 c'4 a4 | % 29
  g,8  bes,8 d8 g8 ~  g8  g8 f8 d8   | \barNumberCheck
  #30
  c8  e8 g8 c'8 ~  c'2 | % 31
...
CityOfStarsAltoSax =  {
  ...
  fis'2 r4 fis''4 | % 29
  e''4 fis''4 g''4 b''4 | \barNumberCheck #30
  ...
  a''4 r8 a''8 a''8  a''8 a''8 ais''8 ~  | % 45
...
CityOfStarsClarinet =  {
  ...
  R1*9 | % 27
  R1*7 | % 34
  r2 ^\markup{ \bold {Moderato} } r4 r8 fis'8 | % 35
