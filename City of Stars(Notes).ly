...
CityOfStarsSopranoOneLyricsOne =  \lyricmode {
  that now our dreams may fi -- nally -- come true
  Ci -- ty of stars  Just one thing ev -- ery bo  -- dy wants 
  there in the bars 
  and through the smoke screen of the crowd -- ed res -- tau -- rants
  "It's" love \skip4 \skip4 \skip4 Yes all we're look _ _ for  love from some -- one else __
  A glance A dance 
  A look in some -- bo -- dy's eyes 
  to light up the skies to o -- pen the world 
  and send them feel -- ing 
  A voice that "says," I'll be there  and "you'll" be al -- right Ah _ _ 
   I "don't" care if I know  just where I go _ cause all that I need's this cra -- zy feel -- ing 
  a rat tat tat on my heart
  Think I want \skip4 \skip4 stay \skip4
  Ci -- ty of stars are you shi -- ning just for me
  Ci -- ty of stars you ne -- ver shined so bright -- "ly " __
}
CityOfStarsSopranoTwo =  {
  \clef "treble" \key d \minor \numericTimeSignature\time 4/4 s1*7
  \break s1*7  | % 15
  s4*7 s4*25 \mf  s1*6 | % 29
  bes'1  s1*7  s4*21 s2 \< s4 \! | % 43
  s1 \f  s4*21 s4 \< s2 \! | \barNumberCheck #50
  s1 \> s1 \! \break | % 52
  s1*5 \mp | % 57
  s1*2 \< | % 59
  s1*2 \! \mf \bar "|."
...
CityOfStarsAltoLyricsOne =  \lyricmode {
  that now our dreams may fi -- nally come true
   Ci -- ty of stars  Just just one thing ev -- ery body wants
   there in the bars 
  and through the smoke screen of the crowd -- ed res -- tau -- rants
  "It's" love  \skip4 \skip4 \skip4 Yes all we're look _ _ for  love from some -- one else __
  ...
  to light up the skies to o -- pen the world 
  and send them feel -- ing 
  A voice that "says," I'll be there  and "you'll" be al -- right "you'll" be al -- right
  I "don't" care if I know  just where I go _ cause all that I need's this cra -- zy feel -- ing 
  a rat tat tat on my heart
  Think I want \skip4 \skip4 stay \skip4
  Ci -- ty of stars you ne -- ver shined so bright -- "ly " __
...
CityOfStarsBassLyricsOne =  \lyricmode {
 Ci  -- ty of stars are you shi -- ning just for me 
 Ci -- ty of stars "there's" so much that I can see 
 Who "knows?"  I felt it from the first em -- brace I shared with you 
  Ci -- ty of stars just one thing ev -- ery bo -- dy wants
  there in the bars 
  and through the smoke screen of the crowd -- ed res -- tau -- rants
