...
RememberMeSoprano = \relative c' {
  ...
  b4 g8 d~d4. d16 b c8 g' g16 a8 a16~a4 r R1*2
  g8 g' g fs fs e e d d b b a g2 r8 g^\cresc g bf bf ef ef g a1\f g2-- g4-- g--
  \bar "||"
  \key g \minor
  \time 3/8
  g8-> r r
...
RememberMeAlto = \relative c' {
  ...
  g e' e d d c16 b~b8 g d' c c b b4 r8 d, e d' d c c b16 b~b8 g bf a a g a4 r8 g
  b4 g8 d~d4. d16 b c8 g' g16 a8 a16~a4 r R1*2
  e8 e' e d d c c b b g g fs e2 r8 ef^\cresc ef g g bf bf ef d1\f ef2-- bf4-- c--
  \bar "||"
  \key g \minor
  \time 3/8
  d8-> r r
...
RememberMeTenor = \relative c' {
  ...
  R1 r2 r4 \tuplet 3/2 { b8 b c } b2.~b16 b b c c8 b b c16 d~d2
  g,8 g' g fs fs e e d d b b a b2 r8 g^\cresc g bf bf ef ef g fs1\f g2-- g4-- g--
  \bar "||"
  \key g \minor
  \time 3/8
  g8-> r r
...
RememberMeBass = \relative c' {
  ...
  g e' e d d c16 b~b8 g d' c c b b4 r8 d, e d' d c c b16 b~b8 g bf a a g a4 r
  R1 r2 r4 \tuplet 3/2 { b8 b c } b2.~b16 b b c c8 b b c16 d~d2
  c,8 c' c c c c c g g fs d ds e2 r8 ef^\cresc ef g g bf bf ef d1\f c2-- ef,4-- f--
  \bar "||"
  \key g \minor
  \time 3/8
  g8-> r r
