...
PorUnaCabezaSoprano =  {
  ...
  \break | % 25
  \key g \minor | % 25
  r4 ^\markup{ \bold {Allegro} } \f bes'4 \times 2/3 {
    bes'4 c''4 d''4
  }
  | % 26
  d''2 a'2 | % 27
  ...
  \bar "||"
  \key g \major e''4 e''4 fis''8 [ g''8 a''8 fis''8 ] \break | % 72
  g''2 r2 \bar "|."
}

PorUnaCabezaSopranoLyrics =  \lyricmode {
  Por un -- na ca -- be -- za To
  -- das las lo -- cu -- ras Su bo -- ca que be -- sa 
  Bo -- rra la tris -- te -- za Cal -- ma la'a -- mar -- gu --  ra
  Por un -- a ca -- be -- za Si e -- lla "me'ol" -- vi
  -- da "Que'im" -- por -- ta per -- der -- "me," Mil ve -- ces la vi -- da Pa -- ra  que vi -- vir
  Ah _ _ _  Ah _ _ _  Ah \skip4 \skip4 \skip4 \skip4 
  Por un -- na
  ca -- be -- za To -- das las lo -- cu -- ras Ah \skip4 \skip4 \skip4
  Ah  gu -- ra Por un -- a ca -- be -- za Si e -- lla "me'ol" -- vi
  -- da "Que'im" -- por -- ta per -- vi -- da Pa -- ra que -- vi vir
}
PorUnaCabezaAlto =  {
  ...
  g'4 d'4 g'8 [ a'8 b'8 g'8 ] \break | % 55
  ...
  | % 62
  g'4 g'4 g'8 [ a'8 bes'8 g'8 ] \break | % 63
  a'4 a'4 g'8 [ a'8 bes'8 g'8 ] | % 64
  bes'2 a'2 | % 65
  R1 | % 66
  r4 a'4 \times 2/3 {
  ...
  \bar "||"
  \key g \major a'4 a'4 fis'8 [ g'8 a'8 fis'8 ] \break | % 72
  g'2 r2 \bar "|."
}
...
PorUnaCabezaAltoLyrics =  \lyricmode {
  ...
  Bo -- rra la tris -- te -- za Cal -- ma la'a -- mar -- gu --  ra
  Por un -- a ca -- be -- za Si e -- lla "me'ol" -- vi
  -- \skip4 \skip1 da _ _ _   Ah  Ah  der -- "me," Mil ve -- ces la vi -- da Pa -- ra  que vi -- vir 
  Pe -- ro si'al gun pin -- go Lle -- ga'a ser fi -- ja'el do -- min -- go
  Yo me jue'go en -- te -- ro Que le voy'a ha -- cer 
  Por un -- na ca -- be -- za 
  To -- das las lo -- cu -- ras 
  Su bo -- ca que be -- sa 
  Bo -- rra la tri -- te -- za 
  Cal  ma "la'a"  mar  gu ra 
  Por un -- a ca -- be -- za Si e -- lla "me'ol" -- vi -- da "Que'im" -- por -- ta per -- vi -- da Pa -- ra que -- vi vir
}
PorUnaCabezaTenor =  {
  ...
  e8 [ d8 ] r4 cis8 [ d8 e8 fis8 ] \break | % 18
  a8 [ g8 ] r4 g8 [ a8 b8 g8 ] | % 19
  a8 [ g8 a8 b8 ] a4. g8 | \barNumberCheck #20
  e'8. r16 r4 c'8 [ b8 g8 e8 ]  | % 21
  e4 e8 [ a8 ] c'8 es'4 d'16 [ c'16 ] | % 22
  b2 g8 [ a8 b8 g8 ] | % 23
  ...
  b8 [ a8 fis8 d8 ] dis8 [ fis8 e8 c8 ] \break | % 48
  ...
  | \barNumberCheck #70
  g2 g8 [ a8 bes8 g8 ] \bar "||"
  \key g \major a4 a4 fis8 [ g8 a8 fis8 ] \break | % 72
  d2 r2 \bar "|."
}

PorUnaCabezaTenorLyrics =  \lyricmode {
  Y que'al re -- gre -- sar pa -- re -- ce de -- cir 
  Por un a ca be za me -- te jon de'un di -- a 
  De'a quel -- la co -- que -- ta'Y ri -- sue -- na mu -- jer
  Que'al ju -- rar son -- rien, El a -- mor que's min -- tien -- do
  Que -- ma'en una ho -- gue -- ra To -- do mi que -- rer 
  Por un -- na ca
  -- be -- za To -- das las lo -- cu -- ras Su bo -- ca que be -- sa
  Bo -- rra la tris -- te -- za Cal -- ma la'a -- mar -- gu --  ra
  Por un ____ a ca -- be -- za Si e -- lla
  "me'ol" -- vi -- da "Que'im" -- por -- ta per -- der -- "me," Mil ve -- ces la vi
  -- da Pa -- ra  que vi -- vir Yo ju -- re mil ve -- ces, No vuel -- "vo'a'in" -- sis "tir," 
  Su bo -- ca de fue -- go Ot -- ta "vez," quei -- ro be -- sar
  Bas -- ta  de ca  -- rre -- sas, Se aca -- bo la  tim -- ba 
  Un fi -- na -- le ni -- do Yo no vuel -- "vo'a" "ver," 
  Yo me jue'go en te -- ro Que le voy'a ha -- cer 
  Por un -- na ca -- be -- za To -- das las lo -- cu -- ras
  Su bo -- ca que be -- sa Bo -- rra la tri -- te -- za Cal -- ma la'a -- mar -- gu -- ra
  Por un -- a
  ca -- be -- za Si e -- lla "me'ol" -- vi -- da "Que'im" -- por -- ta
  per -- der -- Mil ve -- ces la vi -- da Pa -- ra que -- vi vir
}
PorUnaCabezaBass =  {
  \clef "bass" \key g \major \numericTimeSignature\time 4/4 R1*7 | % 8
  r2 b,8 \mf [ c8 cis8 d8 ] | % 9
  e8 [ d8 ] r4 cis8 [ d8 e8 fis8 ] | \barNumberCheck #10
  a8 [ g8 ] r4 b8 [ c'8 a8 b8 ] \break | % 11
  g8 [ a8 fis8 g8 ] fis4. d8 | % 12
  c8 r8 r4 r2 | % 13
  R1 | % 14
  r2 fis8 [ g8 gis8 a8 ]  | % 15
  b8 [ a8 fis8 d8 ] dis8 [ fis8 e8 c8 ] | % 16
  b,8 r4. \mf g,8 [ a,8 ais,8 b,8 ] | % 17
  c8 [ b,8 ] r4 ais,8 [ b,8 c8 d8 ] \break | % 18
  c8 [ b,8 ] r4 b,8 [ c8 d8 e8 ] | % 19
  f8 [ e8 f8 g8 ] f4. b,8 | \barNumberCheck #20
  c8. r16 r4 a8 [ g8 e8 c8 ]  | % 21
  ...
  e8 [ d8 ] r4 cis8 [ d8 e8 fis8 ] \break | % 42
  a8 [ g8 ] r4 r2 | % 43
  R1 | % 44
  r2 c8 [ b,8 ~ ] b,16 [ d8 c16 ]  | % 45
  a,8 r8 r8 r8 c8 [ b,8 d8 c8 ] | % 46
  a,8 r8 r4 r2 | % 47
  R1 \break | % 48
  ...
  \key g \major cis4 cis4 d8 [ e8 fis8 d8 ] \break | % 72
  b,2 r2 \bar "|."
}

PorUnaCabezaBassLyrics =  \lyricmode {
  Por un a ca be za  D'un no -- ble po tri -- lo 
  Que jus -- to'en la ra -- ya a -- flo -- ja'al
  lle -- gar No'o -- vi -- des  her -- ma -- no Vos sa -- bes no'hay que ju-- gar  
  Por un a ca be za me -- te jon de'un di -- a 
  De'a quel -- la co -- que -- ta'Y ri -- sue -- na mu -- jer
  Que'al ju -- rar son -- rien -- do, El a -- mor que's ta min -- tien -- do
  Que -- ma'en una ho -- gue -- ra To -- do mi que -- rer 
  Por un -- na ca -- be -- za To -- das las lo
  -- cu -- ras Su bo -- ca que be -- sa 
  Bo -- rra la tris -- te -- za Cal -- ma la'a -- mar -- gu --  ra
  Por un ____ a ca -- be ____ za Ah _ _ _ Ah vi da 
  "Que'im" -- por -- ta per --
  der -- "me," Mil ve -- ces la Ah -- \skip4 Ah  Cuan -- tos de -- san -- gas -- nos 
  Por --  un -- a ca -- be -- za 
  Pe -- ro si'un mi -- rar Mi hie -- re'al pa -- sar 
  Bas -- ta  de ca  -- rre -- sas, Se aca -- bo la  tim -- ba 
  Un fi -- na -- le ni -- do Yo no vuel -- "vo'a" "ver," 
  Pe -- ro si'al gun pin -- go Lle -- ga'a ser fi -- ja'el do -- min -- go
  Yo me jue'go en -- te -- ro Que le voy'a ha -- cer 
  ...
  "Que'im" -- por -- ta per -- der -- Mil ve -- ces la vi -- da Pa -- ra que -- vi vir
}
